...
public class ViewPostFragment extends Fragment {
    ...
    private String mLikesString = null;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomNavigationView = (BottomNavigationViewEx) view.findViewById(R.id.bottomNavigationView);
    ...
    private void init() {
        try {
            ...
            UniversalImageLoader.setSingleImage(getPhotoFromBundle().getImage_path(), mPostImage, null, "");
...
///
    ...
    private void setupWidgets() {
        ...
        UniversalImageLoader.setSingleImage(mUserAccountSettings.getProfile_path(), mProfileImage, null, "");
        mUsername.setText(mUserAccountSettings.getUsername());

        if (mLikesString == null)
    ...
    private void setupBottomNavigationView() {
        ...
        setupBottomNavigationSetUp(bottomNavigationView);
        enableNavigation(getActivity(), getActivity(), bottomNavigationView);
